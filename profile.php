...
<nav class="navbar navbar-expand-lg navbar-dark primary-color bg-primary" id="navo">
  ...
  <div class="collapse navbar-collapse" id="basicExampleNav">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" id="seephoto">Photos</a>
      </li>      
      <li class="nav-item">
            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  <img alt="Image placeholder" src="<?php print $user["profil"] ?>">
                </span>
                <div class="media-body ml-2 d-none d-lg-block">
                  <span class="mb-0 text-sm  font-weight-bold"><?php  print $user["name"]." "; print $user["surname"]; ?></span>
                </div>
              </div>
            </a>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Hello <?php print $user["name"] ?></h1>
          ...
          <div class="card card-profile shadow">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img id="glavPhoto" src= "<?php print $user["profil"] ?>" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                  <?php print $user["name"]." "; print $user["surname"]; ?><span class="font-weight-light">, <?php print $user["age"] ?></span>
                </h3>
