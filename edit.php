...
<!--               <div class="row">
                ...
                <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                  <div class="text-center text-sm-left mb-2 mb-sm-0">
                    <h4 class="pt-sm-2 pb-1 mb-0 text-nowrap"><?php print $user["name"]." "; print $user["surname"]; ?></h4>
                    <p class="mb-0"><?php print $user["email"] ?></p>
                        ...
                        <div class="row">
                          <div class="col">
                            <div class="form-group">
                              <label>Name</label>
                              <input class="form-control" type="text" name="name" id="editName" value= <?php print $user["name"] ?>>
                            </div>
                          </div>
                          <div class="col">
                            <div class="form-group">
                              <label>Username</label>
                              <input class="form-control" type="text" name="username" id="editSurname" value=<?php print $user["surname"] ?>>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col">
                            <div class="form-group">
                              <label>Age</label>
                              <input class="form-control" type="text" name="age" id="editAge" value= <?php print $user["age"] ?>>
                            </div>
                          </div>
                          <div class="col">
                            <div class="form-group">
                              <label>Email</label>
                              <input class="form-control" type="text" name="email" id="editEmail" value=<?php print $user["email"] ?>>
                            </div>
                          </div>
                        </div>
                      </div>
...
<!--                       <div class="col-12 col-sm-5 offset-sm-1 mb-3">
                    ...
                    <div class="row">
                      <div  class="col d-flex justify-content-end">
                        <span id="saveChanges" class="btn btn-primary">Save Changes</span>
                      </div>
                    </div>
                  </form>
